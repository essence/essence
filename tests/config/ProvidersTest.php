...
class ProvidersTest extends TestCase {
	...
	public function providerProvider( ) {
		...
		return [
			[ '23hq', 'http://www.23hq.com/Zzleeper/photo/16600737', 'author_name', 'Zzleeper' ],
			//[ 'Animoto', '', '', '' ],
			[ 'Aol', 'http://on.aol.com/video/whats-next-for-google-in-two-minutes-518288612?icid=OnTechR3_Img', '', '' ],
			[ 'App.net', 'https://alpha.app.net/chrifpa/post/33532003/photo/1', 'author_name', '@chrifpa' ],
			[ 'Bambuser', 'http://bambuser.com/v/4740575', 'author_name', 'dancole' ],
			[ 'Bandcamp', 'http://jeanjean.bandcamp.com/track/coquin-l-l-phant', 'twitter:image', 'https://f0.bcbits.com/img/a3289609405_2.jpg' ],
			[ 'Blip.tv', 'http://blip.tv/nostalgiacritic/nostalgia-critic-blues-brothers-2000-6908864', 'author_name', 'nostalgiacritic' ],
			[ 'Cacoo', 'http://cacoo.com/diagrams/00e77f4dc9973517', '', '' ],
			[ 'CanalPlus', 'http://www.canalplus.fr/c-divertissement/c-le-grand-journal/pid6831-connasse.html?vid=1067507', 'providerName', 'Canalplus.fr' ],
			[ 'Chirb.it', 'http://chirb.it/7A9L9B', 'author_name', 'nvanderklippe' ],
			[ 'CircuitLab', 'https://www.circuitlab.com/circuit/53xa3r/digital-4-bit-counter-and-dac/', 'author_name', 'CircuitLab' ],
			//[ 'Clikthrough', '', '', '' ],
			[ 'CollegeHumorOEmbed', 'http://www.collegehumor.com/video/6974337/gluten-free-duck', 'author_name', 'CollegeHumor' ],
			[ 'CollegeHumorOpenGraph', 'http://www.collegehumor.com/post/6977539/just-the-tip-15-pop-culture-tip-jars-deserving-of-your-dollar', 'og:site_name', 'CollegeHumor' ],
			[ 'Coub', 'http://coub.com/view/2a93c', 'author_name', 'Marat Akamov' ],
			[ 'Coub', 'http://coub.com/embed/2a93c', 'author_name', 'Marat Akamov' ],
			//[ 'CrowdRanking', '', '', '' ],
			[ 'DailyMile', 'http://www.dailymile.com/people/ben/entries/29297912', 'author_name', 'Ben W.' ],
			[ 'Dailymotion', 'http://www.dailymotion.com/video/x2091k1_pv-nova-comment-faire-un-tube-de-l-ete_fun', 'author_name', 'Golden Moustache' ],
			[ 'Deviantart', 'http://pachunka.deviantart.com/art/Cope-145564099', '', '' ],
			[ 'Dipity', 'http://www.dipity.com/multimediajournalism/30-days-that-destroyed-the-House-of-Murdoch/', 'author_name', 'multimediajournalism' ],
			[ 'Dotsub', 'http://dotsub.com/view/9c63db2a-fa95-4838-8e6e-13deafe47f09', 'author_name', 'liuxt' ],
			[ 'Edocr', 'http://www.edocr.com/doc/176612/saint-petersburg-travellers-guide', 'author_name', 'info_769' ],
			[ 'Flickr', 'https://www.flickr.com/photos/loubella/14540822193/in/explore-2014-06-27', 'author_name', 'Lou-bella' ],
