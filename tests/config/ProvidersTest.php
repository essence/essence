...
class ProvidersTest extends TestCase {
	...
	public function providerProvider( ) {
		...
		return [
			...
			[ 'App.net', 'https://alpha.app.net/chrifpa/post/33532003/photo/1', 'authorName', '@chrifpa' ],
			[ 'Bambuser', 'http://bambuser.com/v/4740575', 'authorName', 'dancole' ],
			[ 'Bandcamp', 'http://jeanjean.bandcamp.com/track/coquin-l-l-phant', 'twitter:image', 'https://f0.bcbits.com/img/a3289609405_2.jpg' ],
			[ 'Blip.tv', 'http://blip.tv/nostalgiacritic/nostalgia-critic-blues-brothers-2000-6908864', 'authorName', 'nostalgiacritic' ],
			...
			[ 'Chirb.it', 'http://chirb.it/7A9L9B', 'authorName', 'nvanderklippe' ],
			[ 'CircuitLab', 'https://www.circuitlab.com/circuit/53xa3r/digital-4-bit-counter-and-dac/', 'authorName', 'CircuitLab' ],
			//[ 'Clikthrough', '', '', '' ],
			[ 'CollegeHumorOEmbed', 'http://www.collegehumor.com/video/6974337/gluten-free-duck', 'authorName', 'CollegeHumor' ],
			...
			[ 'Coub', 'http://coub.com/view/2a93c', 'authorName', 'Marat Akamov' ],
			[ 'Coub', 'http://coub.com/embed/2a93c', 'authorName', 'Marat Akamov' ],
			//[ 'CrowdRanking', '', '', '' ],
			[ 'DailyMile', 'http://www.dailymile.com/people/ben/entries/29297912', 'authorName', 'Ben W.' ],
			[ 'Dailymotion', 'http://www.dailymotion.com/video/x2091k1_pv-nova-comment-faire-un-tube-de-l-ete_fun', 'authorName', 'Golden Moustache' ],
			[ 'Deviantart', 'http://pachunka.deviantart.com/art/Cope-145564099', '', '' ],
			[ 'Dipity', 'http://www.dipity.com/multimediajournalism/30-days-that-destroyed-the-House-of-Murdoch/', 'authorName', 'multimediajournalism' ],
			[ 'Dotsub', 'http://dotsub.com/view/9c63db2a-fa95-4838-8e6e-13deafe47f09', 'authorName', 'liuxt' ],
			[ 'Edocr', 'http://www.edocr.com/doc/176612/saint-petersburg-travellers-guide', 'authorName', 'info_769' ],
			[ 'Flickr', 'https://www.flickr.com/photos/loubella/14540822193/in/explore-2014-06-27', 'authorName', 'Lou-bella' ],
